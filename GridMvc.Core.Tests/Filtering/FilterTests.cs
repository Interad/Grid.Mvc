...
namespace GridMvc.Core.Tests.Filtering
{
    [TestClass]
    public class FilterTests
    {
        ...
        public void Init()
        {
            ...
            _grid = new TestGrid(_repo.GetAll(), _httpContext);
        }
        ...
        [TestMethod]
        public void TestFilteringStringEqualsCaseInsensitive()
        {
            var firstItem = _repo.GetAll().First();
                                                        ...
                                                        Func<TestModel, bool> filterExpression)
        {
            ...
            settingsMock.Setup(s => s.SortSettings).Returns(new QueryStringSortSettings(_httpContext));
