...
namespace GridMvc.Core.Filtering
{
    ...
    public class QueryStringFilterSettings : IGridFilterSettings
    {
        ...
        public QueryStringFilterSettings(HttpContext context)
        {
            ...
            //updated by LM
            string[] filters = Context.Request.Query[DefaultTypeQueryParameter];
            if (filters != null)
            {
        ...
        public bool IsInitState
        {
            get
            {
                ...
                return !String.IsNullOrEmpty(Context.Request.Query.GetValue(DefaultFilterInitQueryParameter));
            }
        }
